...
- **Scale Profile:** Compact Subterranean & Submerged Necropolis
- **Registered Features:** 6

### Geographic & World Context
- **Overview Lore:** A half-submerged necropolis amidst the stagnant oxbows of the Drowned Clearings, where witch-fires flare with renewed, wrathful intensity as mortal logging advances from the north.
- **Host Region:** The Drowned Clearings (Lake)
  - *Host Region Lore:* "A haunted wilderness of stagnant oxbow lakes and reed marshes where witch-fires burn brighter since mortal axes approached from the north, its drowned crypts whispering with restless malevolence."
- **Surrounding Perimeters:**
  ...
  - **NORTH & EAST BORDERS:** Transition into host region (The Drowned Clearings — Lake).
    - *Lore Context:* "A haunted wilderness of stagnant oxbow lakes and reed marshes where witch-fires burn brighter since mortal axes approached from the north, its drowned crypts whispering with restless malevolence."
...
Though isolated amidst swampy oxbows, the tomb's restless spirits have been agitated by mortal expansion along the Sylvan Trace and Eaveshold. Lumber crews and tomb-raiders tread carefully, seeking rare witch-fire moss and ancient relics while fending off marsh horrors.

### Architectural & Spatial Rationale
The physical structure remains anchored in its ancient stone masonry and timber boardwalks, but the surrounding mire and forest reflect increased spirit disturbance and mortal intrusion along the southern approaches.
...
- ID '0': **Frontier Buffer & Drowned Margins** (buffer)
  - Lore: Stagnant oxbow waters of the Drowned Clearings to the north and east, and the cleaved timberlands of the Greenwood Vault to the south and west.
...
- ID '3': **Crypt of Mor-Ghul** (crypt)
  - Lore: Ancient stone chambers illuminated by intensified green witch-fires, where restless spirits whisper among lichen-encrusted sarcophagi.
